...
class AccountManager{
	...
	void delete(){
		...
		System.out.println("Name : "+obj.ownerName + "Account Number : "+obj.accountNumber);
	}
	...
	void display(){
		for(int i=0;i<ind;i++)
		{
			System.out.println("Name : " +account[i].ownerName + " Account No : " + account[i].accountNumber +" Balance : "+ account[i].balance);
		}
	}
}
class Bank{
